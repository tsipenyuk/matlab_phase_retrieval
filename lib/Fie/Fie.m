...
%                         a
% 
% For a detailed discussion of the algorithms used in this code, see the
% following paper:
%    K. Atkinson and L. Shampine: Solving Fredholm integral equations of
%    the second kind in MATLAB, ACM Transactions on Mathematical Software
%    Software, Volume 34 (2008).
%
% INPUT
%
