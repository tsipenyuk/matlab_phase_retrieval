function [g_sol, sqrtI, X] = twoGaussians(nDim, varargin)
% twoGaussians - density corresponding to two gaussians
%
% Synopsis ([]s are optional)
%   [g_sol, sqrtI] = twoGaussians(nDim, [m1], [m2], [Sigma1], [Sigma2],...
%                                  [lb], [ub], [nPts])
%
% Description
...
%      [g,~,x] = twoGaussians(2, 'm1', [0.6 0.3], 'm2', [-0.3 0], ...
%                          'Sigma1', [50 2; 2 10], ...
%                          'Sigma2', [25 -3; 18 10], ...
%                          'nPts', [200 200]);
%   contour(x{1},x{2},g);
%
%   %% 3D
%   [g,~,x] = twoGaussians(3, 'm1', [0.6 0.2 -0.2],...
%                           'm2', [-0.3 0 0.4], ...
